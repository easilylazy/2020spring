...
if __name__ == '__main__':
    ...
    for i in range(1000):
        ...
        #print("name: {0}\n年龄: {1}\n性别: {2}\nidNumber: {3}\n手机号: {4} {5}\n组织机构代码: {6}\n统一社会信用代码: {7}\nunitCharacter: {8}".format(genName(), age, sex, genIdCard(age, gender), list(genMobile().keys())[0], list(genMobile().values())[0], genOrgCode(), list(genCreditCode().keys())[0], list(genCreditCode().values())[0]))
